...
#define Columns_3_PS		(Columns__3__PS)
#define Columns_3_PC		(Columns__3__PC)
#define Columns_3_DR		(Columns__3__DR)
#define Columns_3_SHIFT	(Columns__3__SHIFT)
#define Columns_3_INTR	((uint16)((uint16)0x0003u << (Columns__3__SHIFT*2u)))
