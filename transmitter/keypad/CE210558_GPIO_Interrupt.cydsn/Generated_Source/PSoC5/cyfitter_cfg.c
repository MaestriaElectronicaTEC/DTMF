...
/* PICU_1 Address: CYDEV_PICU_INTTYPE_PICU1_BASE Size (bytes): 8 */
#define BS_PICU_1_VAL ((const uint8 CYFAR *)0x48000384u)

/* PICU_2 Address: CYDEV_PICU_INTTYPE_PICU2_BASE Size (bytes): 8 */
#define BS_PICU_2_VAL ((const uint8 CYFAR *)0x4800038Cu)
...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x4800039Cu)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x480003B8u)
...
void cyfitter_cfg(void)
{
...

	{
		...
		static const cfg_memcpy_t CYCODE cfg_memcpy_list [] = {
			/* dest, src, size */
			{(void CYFAR *)(CYDEV_PICU_INTTYPE_PICU1_BASE), BS_PICU_1_VAL, 8u},
