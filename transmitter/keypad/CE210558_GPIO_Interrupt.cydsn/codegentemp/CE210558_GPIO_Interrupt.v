...
module UART_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("ad99e275-2f10-45d8-aa03-fa98f62a7b3a/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		...
		Rows
		 (.oe(tmpOE__Rows_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__Rows_net[3:0]}),
		  .io({tmpIO_3__Rows_net[3:0]}),
		  .siovref(tmpSIOVREF__Rows_net),
		  .interrupt({Net_128}),
		  .annotation({Net_127, Net_126, Net_125, Net_124}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [7:0] tmpOE__KeyPad_net;
	wire [7:0] tmpFB_7__KeyPad_net;
	wire [7:0] tmpIO_7__KeyPad_net;
	wire [0:0] tmpINTERRUPT_0__KeyPad_net;
	electrical [0:0] tmpSIOVREF__KeyPad_net;

	cy_psoc3_pins_v1_10
		#(.id("ac119e31-a797-4b1e-a262-7ddab6e52b44"),
		...
		KeyPad
		 (.oe(tmpOE__KeyPad_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__KeyPad_net[7:0]}),
		  .io({tmpIO_7__KeyPad_net[7:0]}),
		  .siovref(tmpSIOVREF__KeyPad_net),
		  .interrupt({tmpINTERRUPT_0__KeyPad_net[0:0]}),
		  .annotation({Net_177, Net_176, Net_175, Net_174, Net_173, Net_172, Net_171, Net_170}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KeyPad_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};

	wire [0:0] tmpOE__Notification_net;
	wire [0:0] tmpFB_0__Notification_net;
	wire [0:0] tmpIO_0__Notification_net;
	wire [0:0] tmpINTERRUPT_0__Notification_net;
	electrical [0:0] tmpSIOVREF__Notification_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Notification
		 (.oe(tmpOE__Notification_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Notification_net[0:0]}),
		  .io({tmpIO_0__Notification_net[0:0]}),
		  .siovref(tmpSIOVREF__Notification_net),
		  .interrupt({tmpINTERRUPT_0__Notification_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Notification_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [3:0] tmpFB_3__Columns_net;
	wire [3:0] tmpIO_3__Columns_net;
	electrical [0:0] tmpSIOVREF__Columns_net;

	cy_psoc3_pins_v1_10
		#(.id("0ff82b08-622d-4f24-b525-d7856b2d0edc"),
		  .drive_mode(12'b001_001_001_001),
		  .ibuf_enabled(4'b1_1_1_1),
		  .init_dr_st(4'b0_0_0_0),
		  .input_clk_en(0),
		...
		Columns
		 (.oe(tmpOE__Columns_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__Columns_net[3:0]}),
		  .io({tmpIO_3__Columns_net[3:0]}),
		  .siovref(tmpSIOVREF__Columns_net),
		  .interrupt({Net_139}),
		  .annotation({Net_138, Net_137, Net_136, Net_135}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
