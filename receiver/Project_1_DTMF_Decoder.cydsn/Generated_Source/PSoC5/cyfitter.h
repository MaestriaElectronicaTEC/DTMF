...
/* WaveClock */
#define WaveClock__CFG0 CYREG_CLKDIST_DCFG3_CFG0
#define WaveClock__CFG1 CYREG_CLKDIST_DCFG3_CFG1
#define WaveClock__CFG2 CYREG_CLKDIST_DCFG3_CFG2
#define WaveClock__CFG2_SRC_SEL_MASK 0x07u
#define WaveClock__INDEX 0x03u
#define WaveClock__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define WaveClock__PM_ACT_MSK 0x08u
#define WaveClock__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define WaveClock__PM_STBY_MSK 0x08u
