...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("152fd21c-a4ed-4ade-9bd5-9b5467d4e420"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 mic_AO (
        .connect({
            Net_66
        })
    );
    defparam mic_AO.comp_name = "TestPoint_v1_0";
    defparam mic_AO.port_names = "T1";
    defparam mic_AO.width = 1;
    ...
    cy_annotation_universal_v1_0 C3 (
        .connect({
            Net_154,
            Net_212
        })
    );
    defparam C3.comp_name = "Capacitor_v1_0";
    defparam C3.port_names = "T1, T2";
    defparam C3.width = 2;
